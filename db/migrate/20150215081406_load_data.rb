...
class LoadData < ActiveRecord::Migration
  def up
    ...
    jb = User.create!(:first_name => "Justin", :last_name => "Bieber" ,
                  :password => "Justin", :password_confirmation => "Justin")
    jb.save()
    ph = User.new(:first_name => "Paris",  :last_name => "Hilton",
                  :password => "Paris", :password_confirmation => "Paris")
    ph.save
    mc = User.new(:first_name => "Miley",  :last_name => "Cyrus",
                  :password => "Miley", :password_confirmation => "Miley")
    mc.save()
    bo = User.new(:first_name => "Barack", :last_name => "Obama",
                  :password => "Barrack", :password_confirmation => "Barrack")
    bo.save()
    sc = User.new(:first_name => "Santa", :last_name => "Claus",
                  :password => "Santa", :password_confirmation => "Santa")
    sc.save()
